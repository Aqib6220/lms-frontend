...
const VideoPlayer = ({
  ...
  return (
    <div
      className={`w-full bg-black rounded-lg overflow-hidden ${heightClass}`}
    >
      <video
        ref={videoRef}
        src={videoUrl}
              ...
              >
                <div className="p-6 border-b border-gray-200">
                  ...
                  <p className="text-gray-600 mt-2">
                    Watch the introduction to see if this course is right for
                    you
                  </p>
                </div>
                    ...
                    >
                      ...
                      {chapters.length === 0 ? (
                        <div className="p-6 text-gray-600 bg-gray-50 border border-dashed border-gray-200 rounded-lg">
                          Course chapters will appear here once the instructor
                          adds them.
                        </div>
                      ) : (
                                      ...
                                      (chapter.lessons || []).map(
                                        (lesson, lessonIndex) => {
                                          const isFreePreview =
                                            ...
                                            lessonIndex === 0;
                                          const canAccess =
                                            isAlreadyEnrolled || isFreePreview;
                  ...
                  {activeTab === "instructor" && (
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-4">
                        Senior Educator with 10+ years experience
                      </p>
                      <p className="text-gray-600 max-w-2xl mx-auto">
                        Dedicated to providing quality education to Jammu &
                        Kashmir students with practical knowledge and real-world
                        applications.
                      </p>
                    </motion.div>
                  )}
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl border border-blue-200 p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm text-gray-700">
                    ...
                    <span>
                      {selectedCourse.duration || "10"} hours on-demand video
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-700">
